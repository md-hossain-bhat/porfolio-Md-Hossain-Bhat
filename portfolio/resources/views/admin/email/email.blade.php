					...
					<div class="email-content">
						<div class="">
                            ...
                            @foreach($emails as $email)
								<a href="{{url('admin/email-view/'.$email['id'] )}}">
									<div class="d-md-flex align-items-center email-message px-3 py-1">
										<div class="d-flex align-items-center email-actions">
											...
											<p class="mb-0"><b>{{$email['name']}}</b>
											</p>
										</div>
										<div class="">
											<p class="mb-0">{{Str::limit($email['message'],40)}}</p>
										</div>
										<div class="ms-auto">
											<p class="mb-0 email-time ">{{ date('d-m-Y H:i', strtotime($email->created_at))}}</p>
										</div>
										<div class="ms-auto">
											<p class="mb-0 "><a class="confirmDelete" record="email" recoedid="{{$email->id}}" href="javascript:void('0')" style="font-size: 20px;"><i class="fadeIn animated bx bx-trash-alt text-danger"></i></a></p>
										</div>
									</div>
								</a>
                            @endforeach
